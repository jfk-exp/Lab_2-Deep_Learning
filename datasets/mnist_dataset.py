...
class MNISTDataset:
    def __init__(self, options: ClassificationOptions):
        ...
        self.train_loader = torch.utils.data.DataLoader(
            trainset,
            batch_size=options.batch_size_train, shuffle=True, num_workers=6, pin_memory=True, persistent_workers=True)

        self.test_loader = torch.utils.data.DataLoader(
            testset,
            batch_size=options.batch_size_test, shuffle=True, num_workers=6, pin_memory=True, persistent_workers=True)
